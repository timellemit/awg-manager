...
//go:generate go run github.com/swaggo/swag/cmd/swag@v1.16.4 init -g docs.go -d .,../../internal/api,../../internal/sys/routerinfo,../../internal/diagnostics -o ../../internal/openapi --parseInternal --ot yaml
